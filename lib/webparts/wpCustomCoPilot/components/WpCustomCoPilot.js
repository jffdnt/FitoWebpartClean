        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 11:
                    ...
                    canvasStyleOptions = __assign({ hideUploadButton: true, rootHeight: '100%', rootWidth: '100%', botAvatarBackgroundColor: '#fff', userAvatarBackgroundColor: '#fff' }, avatarOptions);
                    // Render webchat
                    if (token && directline) {
