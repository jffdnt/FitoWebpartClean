...
var CoPilotCustomWP = function (props) {
    ...
    return (React.createElement("section", { className: "".concat(styles.wpCustomCoPilot), style: { width: props.width ? "".concat(props.width, "px") : '100%' } },
        React.createElement("div", { className: styles.header, style: { background: '#009FDB', color: '#fff', padding: '1rem', borderRadius: '4px 4px 0 0', fontWeight: 'bold', fontSize: '1.3rem', letterSpacing: '0.5px' } }, "FiTo AI (Powered by Ask AT&T)"),
