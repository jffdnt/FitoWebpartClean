...
var CoPilotCustomWP = function (props) {
    var botURL = props.botURL, clientID = props.clientID, authority = props.authority, customScope = props.customScope, userDisplayName = props.userDisplayName, botAvatarImage = props.botAvatarImage, botAvatarInitials = props.botAvatarInitials, userEmail = props.userEmail, welcomeMessage = props.welcomeMessage;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 11:
                    ...
                    canvasStyleOptions = __assign({ hideUploadButton: true, rootHeight: '100%', rootWidth: '100%' }, avatarOptions);
                    // Render webchat
                    if (token && directline) {
    ...
    return (React.createElement("section", { className: "".concat(styles.wpCustomCoPilot) },
        React.createElement("div", null,
            React.createElement("h2", null,
                ...
                welcomeMessage,
                ":"),
            React.createElement("div", { className: styles.chatContainer, id: "chatContainer" },
