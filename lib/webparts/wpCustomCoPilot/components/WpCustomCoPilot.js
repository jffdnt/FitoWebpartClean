...
var CoPilotCustomWP = function (props) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 11:
                    ...
                    canvasStyleOptions = __assign({ hideUploadButton: true, rootHeight: '100%', rootWidth: '100%', botAvatarBackgroundColor: '#fff', userAvatarBackgroundColor: '#fff', bubbleBackground: '#EBEBED', bubbleTextColor: '#000', bubbleFromUserBackground: '#0057B8', bubbleFromUserTextColor: '#fff' }, avatarOptions);
                    // Render webchat
                    if (token && directline) {
    ...
    return (React.createElement("section", { className: "".concat(styles.wpCustomCoPilot), style: { width: props.width ? "".concat(props.width, "px") : '100%' } },
        React.createElement("div", null,
            React.createElement("div", { style: { background: '#009FDB', color: '#fff', padding: '1rem', borderRadius: '4px 4px 0 0', fontWeight: 'bold', fontSize: '1.3rem', letterSpacing: '0.5px' } }, "FiTo AI (Powered by Ask AT&T)"),
            React.createElement("div", { className: styles.chatContainer, id: "chatContainer", style: { height: props.height ? "".concat(props.height, "px") : '400px', width: props.width ? "".concat(props.width, "px") : '100%' } },
